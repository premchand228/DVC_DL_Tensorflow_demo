...
def prepare_base_model(config_path, params_path):
    ...
    full_model=prepare_base_model(model,    classes= params["CLASSES"],freeze_all=True ,freeze_till=None,learning_rate=params["LEARNI   NG_RATE"])
    updated_model_path=os.path.join(base_model_dir,artifacts["UPDATED_BASE_MODEL_NAME"])
